...
export const PatientInfoCard = ({ patientData }: PatientInfoCardProps) => {
    const { queueNumber, patient, poli, doctor, visitDate, paymentMethod, status, allergies } = patientData
            ...
            <Row gutter={[16, 16]}>
                ...
                <Col span={5}>
                    ...
                    <div className="text-lg">
                        {patient.gender === 'MALE' || patient.gender === 'male' ? 'Laki-laki' : 'Perempuan'} / {patient.age} tahun
                    </div>
                </Col>
                {visitDate && (
                    <Col span={5}>
