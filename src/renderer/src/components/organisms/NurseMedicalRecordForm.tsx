...
import { Form, Input, InputNumber, Button, Card, Row, Col, App, Space, Select, Tag } from 'antd'
...
export const NurseMedicalRecordForm = ({
  encounterId,
  patientData
}: NurseMedicalRecordFormProps) => {
    ...
    try {
      ...
      if (values.anamnesis.historyOfPresentIllness) {
        conditions.push({
          ...
          notes: values.anamnesis.historyOfPresentIllness
        })
      }
  ...
  return (
    <Form form={form} layout="vertical" onFinish={onFinish} autoComplete="off">
      ...
      <Card title="Pemeriksaan Fisik" className="py-4">
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item
              label="Kesadaran"
      ...
      <Card title="Catatan Tambahan" className="py-4">
