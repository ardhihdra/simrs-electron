...
const POLI_COLORS: { key?: string; bg: string; icon: string; hover: string }[] = [
    ...
    { key: 'penyakit dalam', bg: 'bg-amber-100', icon: 'text-amber-600', hover: 'group-hover:bg-amber-500' },
    ...
    { key: 'saraf',      bg: 'bg-violet-100',  icon: 'text-violet-600',  hover: 'group-hover:bg-violet-500' },
    ...
    { key: 'kulit',      bg: 'bg-orange-100',  icon: 'text-orange-600',  hover: 'group-hover:bg-orange-500' },
    { key: 'gigi',       bg: 'bg-lime-100',    icon: 'text-lime-600',    hover: 'group-hover:bg-lime-500' },
    { key: 'orthopedi',  bg: 'bg-stone-100',   icon: 'text-stone-600',   hover: 'group-hover:bg-stone-500' },
    ...
    { key: 'urologi',    bg: 'bg-emerald-100', icon: 'text-emerald-600', hover: 'group-hover:bg-emerald-500' },
    { key: 'geriatri',   bg: 'bg-yellow-100',  icon: 'text-yellow-600',  hover: 'group-hover:bg-yellow-500' },
    { key: 'rehabilitasi', bg: 'bg-fuchsia-100', icon: 'text-fuchsia-600', hover: 'group-hover:bg-fuchsia-500' },
          ...
          <Col xs={24} sm={12} md={8} lg={6} key={practitioner.id}>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-300 ${color.bg} ${color.hover}`}>
