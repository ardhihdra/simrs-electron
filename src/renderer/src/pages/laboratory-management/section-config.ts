...
const ANCILLARY_SECTION_CONFIG: Record<AncillarySection, AncillarySectionConfig> = {
  laboratory: {
    ...
    queueSubtitle: 'Daftar kunjungan aktif dan pembuatan kunjungan laboratorium',
    queueCreateLabel: 'Registrasi Baru',
    requestsTitle: 'Permintaan Laboratorium',
    requestsSubtitle: 'Manajemen permintaan laboratorium',
    requestsExportTitle: 'Daftar permintaan Laboratorium',
  ...
  radiology: {
    ...
    queueSubtitle: 'Daftar kunjungan aktif dan pembuatan kunjungan radiologi',
    queueCreateLabel: 'Registrasi Baru',
    requestsTitle: 'Permintaan Radiologi',
    requestsSubtitle: 'Manajemen permintaan radiologi',
    requestsExportTitle: 'Daftar permintaan Radiologi',
