...
function NonMedicQueueServicePointWorkspacePage() {
  ...
  const servicePointFromBoard =
    board?.servicePoints.find((item) => item.id === effectiveServicePointId) ?? currentServicePoint
  ...
  async function handleCallNext() {
    ...
    const targetServicePointId = Number.isFinite(parsedServicePointId)
      ? parsedServicePointId
      : selectedServicePointId
        ...
        <Col xs={24} md={6}>
          <Card>
            ...
            <Typography.Text type="secondary">
              {servicePointFromBoard?.code
                ? `Code: ${servicePointFromBoard.code}`
                : 'Belum dipilih'}
            </Typography.Text>
          </Card>
        </Col>
          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            {currentTicket ? (
              ...
              <Empty
                ...
                description="Belum ada tiket aktif di counter ini."
              />
            )}
