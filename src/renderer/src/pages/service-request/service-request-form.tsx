...
function ServiceRequestForm() {
  ...
  const selectedPatient = (patients.data?.data as PatientAttributes[] | undefined)?.find(p => p.id === selectedPatientId)
  ...
  const onFinish = async (values: ServiceRequestFormValues) => {
    try {
      ...
      const patient = (patients.data?.data as PatientAttributes[] | undefined)?.find(p => p.id === values.patientId)
